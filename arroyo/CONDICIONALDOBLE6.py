...
pu_del_arroz_con_pollo=float(os.sys.argv[4])
...
# si el comprador no se pasa de 100 soles le saldra: No se olvide de recargua dinero en su cuenta, cada vez de compre

if(compra_limite==True):
    print("AVISO: Recargue su tarjeta")
else:
    print("No se olvide de recargua dinero en su cuenta, cada vez de compre")
