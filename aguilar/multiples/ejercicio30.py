...
#condicional simple
#SI el puntaje final es mayor o igual a 90 tenga toda la certeza de que va a ingresar
if(puntaje_final>=90):
    print("TENGA TODA LA SEGURIDAD DE QUE VA A INGRESAR")
    print("NO SE DEJE LLEVAR POR LO NERVIOS")
if(puntaje_final>=70 and puntaje_final<90):
    print("LA PROBABILIDAD DE QUE INGRESES ES FAVORABLE")
if(puntaje_final<70):
    print("MEJOR SIGUE PREPARANDOTE")
